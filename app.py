...
def send_js(path):
    return send_from_directory(f'{STATIC_FOLDER}/js', path)

@app.route('/css/<path:path>')
def send_css(path):
    return send_from_directory(f'{STATIC_FOLDER}/css', path)

@app.route('/fonts/<path:path>')
def send_fonts(path):
    return send_from_directory(f'{STATIC_FOLDER}/fonts', path)
